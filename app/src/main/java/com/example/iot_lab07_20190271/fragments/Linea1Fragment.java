...
import com.example.iot_lab07_20190271.dialogs.AddLinea1MovementDialog;
...
public class Linea1Fragment extends Fragment implements MovementAdapter.OnMovementClickListener {
    ...
    private void loadMovements() {
        MovementService.getMovementsByCardType(Constants.CARD_TYPE_LINEA1, new MovementService.MovementCallback() {
            @Override
    ...
    private void showAddMovementDialog() {
        AddLinea1MovementDialog dialog = AddLinea1MovementDialog.newInstance();
        dialog.setOnMovementSavedListener(this::loadMovements);
        dialog.show(getParentFragmentManager(), "AddLinea1MovementDialog");
    }

    private void showEditMovementDialog(Movement movement) {
        AddLinea1MovementDialog dialog = AddLinea1MovementDialog.newInstance(movement);
        dialog.setOnMovementSavedListener(this::loadMovements);
        dialog.show(getParentFragmentManager(), "EditLinea1MovementDialog");
    }

    private void showDeleteConfirmation(Movement movement) {
        new AlertDialog.Builder(requireContext())
                .setTitle("Eliminar Viaje")
                .setMessage("¿Estás seguro de que quieres eliminar este viaje de Línea 1?")
    ...
    // Implementación de MovementAdapter
    @Override
